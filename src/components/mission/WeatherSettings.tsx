    ...
    <div className="space-y-3 bg-gray-50 p-3 rounded-lg">
      ...
      <div className="space-y-2">
        ...
        <div className="flex items-center gap-2">
          <label className="w-16 text-sm text-gray-600">風速</label>
          <input
            type="number"
        ...
        <div className="flex items-center gap-2">
          <label className="w-16 text-sm text-gray-600">風向</label>
          <input
            type="range"
      ...
      <div className="space-y-2 pt-2 border-t border-gray-200">
        <div className="flex items-center gap-2">
          ...
          <label className="flex-1 text-sm text-gray-600">気温</label>
          <input
            type="number"
        ...
        <div className="flex items-center gap-2">
          ...
          <label className="flex-1 text-sm text-gray-600">気圧</label>
          <input
            type="number"
      ...
      <div className="pt-2 border-t border-gray-200">
        <div className="text-xs text-gray-500 space-y-1">
          <div className="font-medium">風速の目安:</div>
